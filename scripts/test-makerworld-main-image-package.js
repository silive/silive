...
assert.match(admin, /data-action="assign-makerworld-direct-image"/)
assert.match(admin, /makerworld-match-candidate/)
assert.match(admin, /Array\.from\(event\.currentTarget\.files \|\| \[\]\)/)
